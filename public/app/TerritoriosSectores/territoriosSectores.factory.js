	...
	angular
		...
		*/
		function store(sector_id, territorios_id){			
			...
			$http({
				method: 'POST',
				url: API_URL + 'territoriosSectores/registro',
				data: data
			})
		...
		*/
		function update(sector_id, territorios_id){
			...
			$http({
				method: 'POST',
				url: API_URL + 'territoriosSectores/editar',
				data: data
			})
				.success(function(response){					
					defered.resolve(response);
		...
		*/
		function ifExist(sector_id, territorio_id){
			...
			$http({
				method: 'GET',
				url: API_URL + 'territoriosSectores/ifExist',
				data: data
			})
				.success(function(response){
		...
		*/
		function getBySectorId(sectorId) {
			 ...
			 $http({
			 	method: 'POST',
			 	url:API_URL + 'territoriosSectores/getBySectorId',
			 	data: data
			 }).success(function(response){			 
			 	defered.resolve(response);
			 }).error(function(err){
