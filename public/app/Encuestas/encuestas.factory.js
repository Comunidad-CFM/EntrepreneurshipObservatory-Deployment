	...
	function EncuestasFactory($http, $q, API_URL) {
        ...
        */
		function store(encuesta) {
			...
			$http({
				method: 'POST',
				url: API_URL + 'encuestas/registro',
				data: encuesta
			})
        ...
        */
		function getAll() {
			...
			$http.get(API_URL + 'encuestas/todas')
			.success(function(response) {
				defered.resolve(response);
			})
			.error(function(err) {
        ...
        */
		function destroy(id) {
			...
			$http({
				method: 'DELETE',
				url: API_URL + 'encuestas/destroy/' + id,
			})
			.success(function(response) {
				defered.resolve(response);
			})
        ...
        */
		function changeState(id, state) {
			...
			$http({
				method: 'POST',
				url: API_URL + 'encuestas/changeState',
				data: data
			})
			.success(function(response) {
				defered.resolve(response);
        ...
        */
		function getQuestions(id)  {
			...
			$http({
				method: 'GET',
				url: API_URL + 'encuestas/getQuestions/' + id
			})
			.success(function(response) {
				defered.resolve(response);
			})
        ...
        */
		function addQuestionsToSurvey(encuestaId, questions) {
			...
			$http({
				method: 'POST',
				url: API_URL + 'encuestasPreguntas/store',
				data: data
			})
			.success(function(response) {
				defered.resolve(response);
        ...
        */
		function deleteQuestionsToSurvey(questions) {
			...
			$http({
				method: 'DELETE',
				url: API_URL + 'encuestasPreguntas/destroy/' + questions,
			})
			.success(function(response) {
				defered.resolve(response);
			})
        ...
        */
		...
		function getpreguntasEncuestas(id)  {
			...
			$http({
				method: 'POST',
				url: API_URL + 'preguntas/encuesta',
				data: data
			})
			.success(function(response) {
				defered.resolve(response);
		...
		function getEncuestas(id)  {
			...
			$http({
				method: 'POST',
				url: API_URL + 'encuestas/getEncuestas',
				data: data
			})
				.success(function(response) {
					defered.resolve(response);
		...
		function getNumberOfQuestions(idEncuesta){
			...
			$http({
				method: 'GET',
				url: API_URL + 'encuestasPreguntas/getNumberOfQuestions/' + idEncuesta,
			})
				.success(function(response) {
					defered.resolve(response);
				})
