	...
	*/
	function AplicacionesFactory($http, $q, API_URL) {
		...
		function getAll() {
			...
			$http.get(API_URL + 'aplicaciones/todas')
		...
		*/
		function getForSurvey(idEncuesta) {
			...
			$http({
				method: 'POST',
				url: API_URL + 'aplicaciones/getForSurvey',
				data: data
			})
			.success(function(response) {
				defered.resolve(response);
		...
		*/
		function store(entrepreneurs, idPeriodo, fecha, idEncuesta) {
			...
			$http({
				method: 'POST',
				url: API_URL + 'aplicaciones/store',
				data: data
			})
			.success(function(response) {
				defered.resolve(response);
		...
		*/
		function remove(aplications) {
			...
			$http({
				method: 'DELETE',
				url: API_URL + 'aplicaciones/destroy/' + aplications
			})
			.success(function(response) {
				defered.resolve(response);
			})
		...
		*/
		function getAplicacionesByPersona(idPersona) {
			...
			$http({
				method: 'POST',
				url: API_URL + 'aplicaciones/getAplicacionesByPersona',
				data: data
			})
			.success(function(response) {
				defered.resolve(response);
		...
		function getAplicacionesPersonasEncuestas() {
			...
			$http.get(API_URL + 'aplicaciones/personasEncuestas')
			.success(function(response) {
				defered.resolve(response);
			})
			.error(function(err) {
		...
		function update(idAplicacion, encuestador) {
			...
			$http({
				method: 'POST',
				url: API_URL + 'aplicaciones/update',
				data: data
			})
			.success(function(response) {
				defered.resolve(response);
